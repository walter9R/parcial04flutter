...
class UdpCliente extends StatefulWidget {
  final cliente_upd;
  
  const UdpCliente(
    {super.key,
    required this.cliente_upd}
  );

  @override
  State<UdpCliente> createState() => _UdpClienteState();
}

class _UdpClienteState extends State<UdpCliente> {
  ...
  void initState() {
    super.initState();
    _cedulaController.text = widget.cliente_upd['cedula'].toString();
    ...
    _usuarioController.text = widget.cliente_upd['usuario'].toString();
    dropdownValueTipoCli = widget.cliente_upd['tipo'].toString();;
